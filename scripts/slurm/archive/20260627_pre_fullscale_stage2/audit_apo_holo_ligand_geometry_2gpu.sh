#!/bin/bash
#SBATCH --job-name=s1_apoholo_geom
...
#SBATCH --output=logs/slurm/stage1_apoholo_geom_%j.out
#SBATCH --error=logs/slurm/stage1_apoholo_geom_%j.err
...
TAG="${TAG:-apo_holo_ligand_geometry_$(date +%Y%m%d_%H%M%S)}"
...
echo "=============================================="
echo "Stage-1 apo-vs-holo ligand geometry audit (2-GPU)"
echo "=============================================="
...
torchrun --nproc_per_node=2 scripts/audit_apo_holo_ligand_geometry.py \
...
echo ""
echo "=============================================="
echo "Apo-vs-holo geometry audit completed: $(date)"
echo "JSON: $OUT_DIR/apo_holo_ligand_geometry.json"
echo "CSV:  $OUT_DIR/apo_holo_ligand_geometry_per_sample.csv"
echo "=============================================="
