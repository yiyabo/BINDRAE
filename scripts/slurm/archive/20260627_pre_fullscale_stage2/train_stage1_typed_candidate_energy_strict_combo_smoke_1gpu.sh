...
#SBATCH --output=logs/slurm/stage1_typed_strict_combo_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_typed_strict_combo_1gpu_%j.err
...
TAG="${TAG:-typed_candidate_energy_strict_combo_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 typed candidate strict-control smoke (1-GPU)
============================================================
...
No-harm weight:  $TYPED_NOHARM_WEIGHT
Noncontact zero: $TYPED_NONCONTACT_ZERO_WEIGHT
Selection metric:$SELECTION_METRIC
Num workers:     $NUM_WORKERS
Batch size:      $BATCH_SIZE
Residue budget:  $RESIDUE_BUDGET
Goal:            smoke strict scrambled+shuffled validation without DDP/NCCL
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "Strict-control 1-GPU smoke completed: $(date)"
