#!/bin/bash
#SBATCH --job-name=s1_typed_strict
...
#SBATCH --output=logs/slurm/stage1_typed_strict_combo_%j.out
#SBATCH --error=logs/slurm/stage1_typed_strict_combo_%j.err
...
TAG="${TAG:-typed_candidate_energy_strict_combo_smoke_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 typed candidate strict-control smoke (4-GPU)
============================================================
...
Goal:            smoke strict scrambled+shuffled validation before longer runs
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "Strict-control smoke completed: $(date)"
