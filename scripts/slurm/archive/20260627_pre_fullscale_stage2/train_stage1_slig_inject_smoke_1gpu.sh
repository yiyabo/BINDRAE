...
#SBATCH --output=logs/slurm/stage1_slig_inject_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_slig_inject_1gpu_%j.err
...
TAG="${TAG:-slig_inject_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 s_lig direct injection smoke (1-GPU)
============================================================
...
Goal:            test direct s_lig injection for ligand-type discrimination
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "s_lig injection smoke completed: $(date)"
