...
#SBATCH --output=logs/slurm/stage1_discriminator_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_discriminator_1gpu_%j.err
...
TAG="${TAG:-ligand_discriminator_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 ligand discriminator smoke (1-GPU, two-stage)
============================================================
...
Goal:            train independent ligand discriminator with frozen rotamer
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "Ligand discriminator smoke completed: $(date)"
