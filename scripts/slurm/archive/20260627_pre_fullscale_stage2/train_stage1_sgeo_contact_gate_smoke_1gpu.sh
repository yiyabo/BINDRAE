...
#SBATCH --output=logs/slurm/stage1_sgeo_contact_gate_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_sgeo_contact_gate_1gpu_%j.err
...
TAG="${TAG:-sgeo_contact_gate_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 s_geo contact-gated injection smoke (1-GPU)
============================================================
...
Goal:            test contact-gated s_geo injection for ligand-type discrimination
Start:           $(date)
============================================================
EOF
...
python scripts/train_stage1.py \
  ...
  --geometry_scorer_use_sgeo_contact_gate \
  --geometry_scorer_contact_gate_d0 6.0 \
...
echo ""
echo "============================================================"
echo "s_geo contact-gated smoke completed: $(date)"
