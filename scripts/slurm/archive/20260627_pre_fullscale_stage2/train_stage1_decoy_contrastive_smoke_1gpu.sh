...
#SBATCH --output=logs/slurm/stage1_decoy_contrastive_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_decoy_contrastive_1gpu_%j.err
...
TAG="${TAG:-decoy_contrastive_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 decoy contrastive loss smoke (1-GPU)
============================================================
...
Goal:            test strong contrastive loss (margin + repulsion) for ligand discrimination
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "Decoy contrastive smoke completed: $(date)"
