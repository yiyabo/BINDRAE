...
#SBATCH --output=logs/slurm/stage1_ligand_guidance_full_8gpu_%j.out
#SBATCH --error=logs/slurm/stage1_ligand_guidance_full_8gpu_%j.err
...
TAG="${TAG:-ligand_guidance_full_8gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 ligand internal guidance FULL training (8-GPU, RAEv2-inspired)
============================================================
