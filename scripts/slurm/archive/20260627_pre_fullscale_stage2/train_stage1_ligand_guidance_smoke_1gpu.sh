...
#SBATCH --output=logs/slurm/stage1_ligand_guidance_1gpu_%j.out
#SBATCH --error=logs/slurm/stage1_ligand_guidance_1gpu_%j.err
...
TAG="${TAG:-ligand_guidance_smoke_1gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
============================================================
Stage-1 ligand internal guidance smoke (1-GPU, RAEv2-inspired)
============================================================
...
Goal:            test RAEv2-inspired ligand internal guidance
Start:           $(date)
============================================================
EOF
...
echo ""
echo "============================================================"
echo "Ligand guidance smoke completed: $(date)"
