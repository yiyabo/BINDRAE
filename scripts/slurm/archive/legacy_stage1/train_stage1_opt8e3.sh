...
#SBATCH --output=logs/slurm/stage1_opt8e3_%j.out
#SBATCH --error=logs/slurm/stage1_opt8e3_%j.err
...
CKPT_TAG="opt8e3_$(date +%Y%m%d_%H%M%S)"

echo "=============================================="
echo "Stage-1 medium 8GPU E3: w_fape=0.5"
echo "=============================================="
