...
#SBATCH --output=logs/slurm/stage1_geom_m3_%j.out
#SBATCH --error=logs/slurm/stage1_geom_m3_%j.err
...
TAG="${TAG:-geom_m3_sgeo_4gpu_$(date +%Y%m%d_%H%M%S)}"
...
echo "=============================================="
echo "Stage-1 Geometry+s_geo M3 Scorer (4-GPU)"
echo "=============================================="
...
echo "Mode:       M3 (geometry + s_geo projection)"
echo "Start:      $(date)"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "M3 scorer training completed: $(date)"
