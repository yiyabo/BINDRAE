...
#SBATCH --output=logs/slurm/stage1_arch1_%j.out
#SBATCH --error=logs/slurm/stage1_arch1_%j.err
...
CKPT_TAG="arch1_$(date +%Y%m%d_%H%M%S)"

echo "=============================================="
echo "Stage-1 architecture run 1: E6b strategy + late pocket chi1 expert"
echo "=============================================="
...
torchrun \
  ...
  --use_pocket_chi1_expert \
  --pocket_chi1_expert_hidden 128 \
  --pocket_chi1_expert_layers 2 \
  --pocket_chi1_gate_threshold 0.5 \
  --pocket_chi1_residual_scale 0.25 \
