...
#SBATCH --output=logs/slurm/stage1_opt8e5a_%j.out
#SBATCH --error=logs/slurm/stage1_opt8e5a_%j.err
...
CKPT_TAG="opt8e5a_$(date +%Y%m%d_%H%M%S)"

echo "=============================================="
echo "Stage-1 medium 8GPU E5a: lambda_pchi1=0.2"
echo "=============================================="
