...
#SBATCH --output=logs/slurm/stage1_candidate_8gpu_%j.out
#SBATCH --error=logs/slurm/stage1_candidate_8gpu_%j.err
...
TAG="${TAG:-candidate_chi1_8gpu_$(date +%Y%m%d_%H%M%S)}"
...
echo "=============================================="
echo "Stage-1 candidate-aware 8-GPU DDP training"
echo "=============================================="
...
echo "LR:         $LR (scorer: x${CANDIDATE_SCORER_LR_SCALE})"
...
echo ""
echo "=============================================="
echo "8-GPU candidate training completed: $(date)"
