...
#SBATCH --output=logs/slurm/stage1_opt8e5b_%j.out
#SBATCH --error=logs/slurm/stage1_opt8e5b_%j.err
...
CKPT_TAG="opt8e5b_$(date +%Y%m%d_%H%M%S)"

echo "=============================================="
echo "Stage-1 medium 8GPU E5b: lambda_pchi1=0.4"
echo "=============================================="
