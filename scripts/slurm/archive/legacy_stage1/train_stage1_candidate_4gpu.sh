...
#SBATCH --output=logs/slurm/stage1_candidate_4gpu_%j.out
#SBATCH --error=logs/slurm/stage1_candidate_4gpu_%j.err
...
TAG="${TAG:-candidate_chi1_4gpu_$(date +%Y%m%d_%H%M%S)}"
...
echo "=============================================="
echo "Stage-1 candidate-aware 4-GPU DDP training"
echo "=============================================="
...
echo ""
echo "=============================================="
echo "4-GPU candidate training completed: $(date)"
