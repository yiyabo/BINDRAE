...
#SBATCH --output=logs/slurm/stage1_geom_4gpu_%j.out
#SBATCH --error=logs/slurm/stage1_geom_4gpu_%j.err
...
TAG="${TAG:-geom_scorer_4gpu_$(date +%Y%m%d_%H%M%S)}"
...
LAMBDA_GEOMETRY_CHI1="${LAMBDA_GEOMETRY_CHI1:-1.0}"
GEOMETRY_SCORER_LR_SCALE="${GEOMETRY_SCORER_LR_SCALE:-1.0}"

echo "=============================================="
echo "Stage-1 Geometry Candidate Scorer (4-GPU)"
echo "=============================================="
echo "Job ID:     $SLURM_JOB_ID"
echo "Node:       $SLURM_NODELIST"
echo "Tag:        $TAG"
echo "Resume:     $RESUME_FROM"
echo "LR:         $LR (scorer: x${GEOMETRY_SCORER_LR_SCALE})"
echo "Max epochs: $MAX_EPOCHS"
echo "Lambda geom:$LAMBDA_GEOMETRY_CHI1"
echo "Start:      $(date)"
echo "=============================================="
...
"$TORCHRUN_BIN" \
  ...
  --geometry_scorer_lr_scale "$GEOMETRY_SCORER_LR_SCALE" \
...
echo ""
echo "=============================================="
echo "Geometry scorer training completed: $(date)"
