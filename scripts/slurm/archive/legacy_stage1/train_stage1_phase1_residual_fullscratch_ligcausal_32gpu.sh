#!/bin/bash
#SBATCH --job-name=s1_p1_zero_lift32
...
#SBATCH --output=logs/slurm/stage1_phase1_fullscratch_ligcausal_32gpu_%j.out
#SBATCH --error=logs/slurm/stage1_phase1_fullscratch_ligcausal_32gpu_%j.err
...
TAG="${TAG:-phase1_residual_fullscratch_ligcausal_32gpu_$(date +%Y%m%d_%H%M%S)}"
...
cat <<EOF
==============================================
Stage-1 Phase-1 Residual: full from-scratch ligand-causal training (32-GPU template)
==============================================
...
echo ""
echo "=============================================="
echo "32-GPU full from-scratch ligand-causal Phase-1 residual training completed: $(date)"
