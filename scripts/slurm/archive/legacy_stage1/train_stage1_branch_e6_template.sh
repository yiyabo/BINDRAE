#!/bin/bash
# Shared-prefix branch template for E6-style experiments.
# REQUIRED: edit PREFIX_CKPT, BRANCH_TAG, and branch-specific pchi1 arguments before submission.

#SBATCH --job-name=s1_branch_e6
...
#SBATCH --output=logs/slurm/stage1_branch_e6_%j.out
#SBATCH --error=logs/slurm/stage1_branch_e6_%j.err
...
PREFIX_CKPT="checkpoints/stage1/REPLACE_PREFIX_TAG/epoch_005.pt"
BRANCH_TAG="e6a_from_REPLACE_PREFIX_TAG_$(date +%Y%m%d_%H%M%S)"
...
echo "=============================================="
echo "Stage-1 E6 branch run from shared prefix"
echo "=============================================="
